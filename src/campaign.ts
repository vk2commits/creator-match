...
export const GOALS = [
  {id:'awareness',label:'제품 알리기',detail:'콘텐츠가 얼마나 조회되는지',priority:'reach'},
  {id:'engagement',label:'관심·반응 얻기',detail:'좋아요·댓글 등 반응이 생기는지',priority:'response'},
  {id:'sales',label:'구매로 연결하기',detail:'클릭·구매는 집행 후 별도 기록',priority:'balanced'},
] as const;
